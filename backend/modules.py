...
def analyze_sentiment(transcription):
    ...
    # my own fine-tuned model (from local files; can also be accessed publicly via Hugging Face)
    sentiment_analyzer = pipeline("sentiment-analysis", model="sangkm/augmented-go-emotions-plus-other-datasets-fine-tuned-distilroberta-v2", return_all_scores=True)
